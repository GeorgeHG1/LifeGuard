...
class DeviceDetailsActivity : AppCompatActivity() {
    ...
    private val pollingRunnable = object : Runnable {
        override fun run() {
            if (isPolling) {
                ...
                pollingHandler.postDelayed(this, 30000)
            }
        }
    }
                ...
                response.use { resp ->
                    ...
                    try {
                        ...
                        if (timestampString.isNotEmpty()) {
                            ...
                            if (nowMs - recordTimeMs > 0 && alertProbability > 0.3) {
    ...
    private fun showPredictionDialog(message: String) {
            ...
            TwilioCallHelper.makeCall("+1234567890", "Warning! You are the emergency contact for a lifeguard user. They are at high risk of a heart attack, please get them medical attention.")

            AlertDialog.Builder(this)
                .setTitle("Risk Assessment Alert")
                .setMessage("Warning! You are at high risk of a heart attack. Please seek immediate medical assistance.")
